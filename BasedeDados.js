// PreScript
  ...
  const tabela = [
    ...
    ['Talão','1 Via','10 x 14','Preto e Branco','4',35,20,'OFS'],
    ['Talão','1 Via','10 x 14','Preto e Branco','8',60,35,'OFS'],
    ['Talão','1 Via','10 x 14','Preto e Branco','12',85,50,'OFS'],
    ['Talão','1 Via','10 x 14','Preto e Branco','20',120,70,'OFS'],
    ['Talão','2 Via','10 x 14','Preto e Branco','4',45,25,'OFS'],
    ['Talão','2 Via','10 x 14','Preto e Branco','8',75,45,'OFS'],
    ['Talão','2 Via','10 x 14','Preto e Branco','12',100,60,'OFS'],
    ['Talão','2 Via','10 x 14','Preto e Branco','20',135,80,'OFS'],
    ['Talão','1 Via','10 x 14','Colorido','4',60,35,'OFS'],
    ['Talão','1 Via','10 x 14','Colorido','8',85,50,'OFS'],
    ['Talão','1 Via','10 x 14','Colorido','12',120,70,'OFS'],
    ['Talão','1 Via','10 x 14','Colorido','20',145,85,'OFS'],
    ['Talão','2 Via','10 x 14','Colorido','4',70,40,'OFS'],
    ['Talão','2 Via','10 x 14','Colorido','8',100,60,'OFS'],
    ['Talão','2 Via','10 x 14','Colorido','12',135,80,'OFS'],
    ['Talão','2 Via','10 x 14','Colorido','20',170,100,'OFS'],
    
    ['Talão','1 Via','14 x 20','Preto e Branco','2',35,20,'OFS'],
    ['Talão','1 Via','14 x 20','Preto e Branco','4',60,35,'OFS'],
    ['Talão','1 Via','14 x 20','Preto e Branco','10',120,70,'OFS'],
    ['Talão','1 Via','14 x 20','Preto e Branco','20',220,130,'OFS'],
    ['Talão','2 Via','14 x 20','Preto e Branco','2',45,25,'OFS'],
    ['Talão','2 Via','14 x 20','Preto e Branco','4',75,45,'OFS'],
    ['Talão','2 Via','14 x 20','Preto e Branco','10',135,80,'OFS'],
    ['Talão','2 Via','14 x 20','Preto e Branco','20',245,145,'OFS'],
    ['Talão','1 Via','14 x 20','Colorido','2',60,35,'OFS'],
    ['Talão','1 Via','14 x 20','Colorido','4',85,50,'OFS'],
    ['Talão','1 Via','14 x 20','Colorido','10',145,85,'OFS'],
    ['Talão','1 Via','14 x 20','Colorido','20',270,160,'OFS'],
    ['Talão','2 Via','14 x 20','Colorido','2',70,40,'OFS'],
    ['Talão','2 Via','14 x 20','Colorido','4',100,60,'OFS'],
    ['Talão','2 Via','14 x 20','Colorido','10',170,100,'OFS'],
    ['Talão','2 Via','14 x 20','Colorido','20',300,175,'OFS'],

    ['Talão','1 Via','9 x 21','Preto e Branco','3',35,20,'OFS'],
    ['Talão','1 Via','9 x 21','Preto e Branco','6',60,35,'OFS'],
    ['Talão','1 Via','9 x 21','Preto e Branco','9',85,50,'OFS'],
    ['Talão','1 Via','9 x 21','Preto e Branco','12',100,60,'OFS'],
    ['Talão','2 Via','9 x 21','Preto e Branco','3',40,25,'OFS'],
    ['Talão','2 Via','9 x 21','Preto e Branco','6',75,45,'OFS'],
    ['Talão','2 Via','9 x 21','Preto e Branco','9',100,60,'OFS'],
    ['Talão','2 Via','9 x 21','Preto e Branco','12',120,70,'OFS'],
    ['Talão','1 Via','9 x 21','Colorido','3',60,35,'OFS'],
    ['Talão','1 Via','9 x 21','Colorido','6',85,50,'OFS'],
    ['Talão','1 Via','9 x 21','Colorido','9',120,70,'OFS'],
    ['Talão','1 Via','9 x 21','Colorido','12',135,80,'OFS'],
    ['Talão','2 Via','9 x 21','Colorido','3',70,40,'OFS'],
    ['Talão','2 Via','9 x 21','Colorido','6',110,65,'OFS'],
    ['Talão','2 Via','9 x 21','Colorido','9',135,80,'OFS'],
    ['Talão','2 Via','9 x 21','Colorido','12',155,90,'OFS'],
    ...
    ["Envelopamento", "Geladeira", "2 Portas", "-", "-", 220, 0, "QNT","TabelaProdutos/Geladeira 2 Portas.jpg"],
    ["Envelopamento", "Geladeira", "1 Porta", "-", "-", 150, 0, "QNT","TabelaProdutos/Geladeira 1 Porta.jpg"],
